...
gather.say(ssml(
“Greetings! <break time='400ms'/> Thank you for calling “
“<emphasis level='moderate'>Disney’s All-Star Music Resort</emphasis> “
...
gather.say(ssml(
“Please enter the time for your wakeup, <break time='200ms'/> “
“followed by the pound key. <break time='500ms'/> “
“For example, <break time='200ms'/> for six A M, <break time='200ms'/> “
“press zero six zero zero, <break time='200ms'/> then pound.”
), voice=VOICE)
r.append(gather)
r.say(ssml(“We didn’t receive your input. <break time='300ms'/> Goodbye!”), voice=VOICE)
return Response(str(r), mimetype=“text/xml”)
